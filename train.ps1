...
$pretrained_model = "./sd-models/model.ckpt" # base model path | 底模路徑 (pruned或full都行，不要vae)
...
$lr_restart_cycles = 1 # cosine_with_restarts restart cycles | 餘弦退火重啟次數，僅在 lr_scheduler 為 cosine_with_restarts 時起效。
