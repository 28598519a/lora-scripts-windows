python\python.exe -m pip install torch==2.0.1+cu118 torchvision==0.15.2+cu118 --index-url https://download.pytorch.org/whl/cu118

cd sd-scripts
..\python\python.exe -m pip install --upgrade -r requirements.txt
..\python\python.exe -m pip install -U -I --no-deps xformers==0.0.19
